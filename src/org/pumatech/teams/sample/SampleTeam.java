...
public class SampleTeam extends Team {
	...
	public SampleTeam(String name, Color color) {
		...
		addPlayer(new DefensivePlayer(new Location(5, 30)));
		addPlayer(new DefensivePlayer(new Location(10, 30)));
		addPlayer(new DefensivePlayer(new Location(15, 30)));
		addPlayer(new DefensivePlayer(new Location(20, 30)));
		addPlayer(new DefensivePlayer(new Location(30, 30)));
		addPlayer(new DefensivePlayer(new Location(35, 30)));
		addPlayer(new DefensivePlayer(new Location(40, 30)));
		addPlayer(new DefensivePlayer(new Location(45, 30)));
